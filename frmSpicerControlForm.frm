...
Begin VB.Form frmSpicerControlForm 
   BackColor       =   &H00FFFFFF&
   ...
   End
End
Attribute VB_Name = "frmSpicerControlForm"
...
Private Sub Form_Unload(Cancel As Integer)
   ...
   On Error GoTo ERROR_HANDLER
    ...
    frmExportFromArchive.poSendMail_Status "+++ frmSpicerControlForm - Form_Unload()  | SpicerDoc1.CloseDocument (False)"
...
ERROR_HANDLER:
    ...
    frmExportFromArchive.poSendMail_Status "+++ frmSpicerControlForm - Form_Unload()  ERROR:   Error #: " & Err.Number & " - " & Err.Description
    funcWriteToDebugLog Me.name, "+++ frmSpicerControlForm - Form_Unload()  ERROR:   Error #: " & Err.Number & " - " & Err.Description
    funcWriteToSystemEventLog frmImaging101AutoExport.NTService1, svcMessageError, "+++ frmSpicerControlForm - Form_Unload()  ERROR:   Error #: " & Err.Number & " - " & Err.Description
